...
class OpenaiChatgptApiConnector(BaseConnector):

    def __init__(self):

        # Call the BaseConnectors init first
        super(OpenaiChatgptApiConnector, self).__init__()
    ...
    def _handle_get_moderation(self, param):
...
def main():
    ...
    with open(args.input_test_json) as f:
        ...
        connector = OpenaiChatgptApiConnector()
